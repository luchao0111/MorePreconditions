...
public final class MorePreconditions
{
    ...
    {
        MorePreconditions.checkNotNull(set, "Collection");
        MorePreconditions.checkNotNull(value, "value");
    ...
    {
        MorePreconditions.checkNotNull(map, "Map");
        MorePreconditions.checkNotNull(key, "key");
    ...
    {
        MorePreconditions.checkNotNull(collection, "collection");
    ...
    {
        MorePreconditions.checkNotNull(value, "String");
        if ("".equals(value))
        {
    ...
    {
        MorePreconditions.checkNotNull(startOfString, "start of string");
        MorePreconditions.checkNotEmpty(startOfString, "start of string");
        MorePreconditions.checkNotNull(toCheck, "string to check");
    ...
    public static <T> void eitherOrIsNull(final T one, final T two, final String nameOne, final String nameTwo)
    {
        ...
        {
            throw new IllegalArgumentException("Reference One and Two are null, but expected that just one have to be null of :\n" + nameOne + "\n" + nameTwo);
        }

        if (one != null && two != null)
        {
            throw new IllegalArgumentException("Reference One and Two are Valid, but expected that just one have to be valid of :\n" + nameOne + "\n" + nameTwo);
        }
    }
